...
class AddPersonInfoDialog(context: Context, var addDialogListener: AddPersonInfoListener) :
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            button2.setOnClickListener {
                ...
                val item = Person_Details(name = name, age = age, address = address, cgpa = cgpa, education = education, ph_number =ph_number)
